...
def generate_ai_image(name: str, country: str, zodiac: str, output_path: str = "output/ai_image.png") -> str:
    ...
    prompt = (
        ...
        f"The person is smiling or appearing calm and composed, dressed in his/her famous attire related to his/her work. The overall aesthetic is cinematic, clean, and respectful.\n\n"
